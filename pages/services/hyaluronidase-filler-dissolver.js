...
// ------------------------------------------------
    ...
    an1:
     "As with any injections, you may experience some redness, tenderness, bruising or swelling. This can be alleviated with ice packs and over-the-counter paracetamol. You can expect these issues to subside in just a day or two.",
...
// ----------------------------------------------
    ...
    an2:
     "The filler begins to soften and break down immediately. After 48 hours, you should be able to see the real difference. It is important to remember that the injection of hyaluronidase itself can result in some swelling, meaning that its true effects will be hidden for a short amount of time.",
...
// ---------------------------------------------------
    ...
    an3:
     "As long as you are not allergic to hyaluronidase, yes you can, regardless of your age, gender or skin type! You must not receive any anti-wrinkle injections 48 hours before or after this procedure.",
...
faq4: 
    ...
    an4: 
    "Of course! You will need to wait until the area is fully healed before having more filler, but following that, it is perfectly safe to undergo filler treatments again.",
