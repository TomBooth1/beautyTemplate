...
// ------------------------------------------------
     faq1: 
     "Who Is The Kim K Package Suitable For?",

    an1:
     "This treatment is suitable for anyone over the age of 18. If you feel self-conscious about your jawline, chin and/or cheekbones, then you will be delighted with the results!",
...
// ----------------------------------------------
    ...
    an2:
     "As you can probably imagine, the treatment can be somewhat uncomfortable, however, any discomfort is minimal and the results definitely make it worth it!",
...
// ---------------------------------------------------
    ...
    an3:
     "The Kim K package offers long-term (but not permanent) results. The full effects of the treatment typically last for around a year, however, this varies from person to person and will depend upon your natural metabolism.",
...
faq4: 
    ...
    an4: 
    "Following the treatment, you can get back to your normal activities pretty much straight away. There may be some minor redness, swelling and bruising, but this will disappear in just a few days.",
