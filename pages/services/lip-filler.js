...
export default function LipFiller() {
  const faq = {
    ...
    // ------------------------------------------------
    faq1: "Can Lip Fillers Be Removed?",

    an1: "Yes. Lip Fillers can be easily removed almost instantly, with no lasting damage.",
    ...
    an1_3: "",
    // ----------------------------------------------
    faq2: "Can Lip Fillers Look Natural?",

    an2: "Of course! Provided that you get them done by experienced professionals, like us",
    ...
    // ---------------------------------------------------
    faq3: "What Happens After Lip Filler Treatment?",

    an3: "So, our Lip Fillers will have you looking and feeling gorgeous, but it’s not 100% satisfaction straight away!",
    ...
    an3_3: "",
    // -------------------------------------------------
    faq4: "What Is In Lip Fillers?",

    an4: "Juvederm is made from biodegradable materials, is biocompatible and contains hyaluronic acid (the naturally occurring substance we talked about above). Introducing a little extra HA offers amazing, natural-looking results!",
  ...
  return (
    <div className={styles.page_container}>
      ...
      <PageHeader title="Lip Fillers" src="/lipFiller.png" />

      <PageMain questions={faq} title="Lip Fillers" />
      <Footer />
    </div>
  );
}
