...
export default function ChinFiller() {
  const faq = {
    ...
    // ------------------------------------------------
    faq1: "How Do Chin Fillers Work??",

    an1: "The injection of dermal filler plumps the skin, allowing us to reshape the chin without the need for surgery. This means that you can obtain your ideal facial structure whilst foregoing the risks associated with going under general anesthetic, and without the downtime that comes alongside such surgeries.",

    an1_2: "",

    an1_3: "",
    // ----------------------------------------------
    faq2: "How Long Do They Last?",

    an2: "All skin is different, therefore, the length of time that fillers last from person to person can vary. However, Chin Fillers typically last between 12 and 18 months.",

    an2_2: "",

    an2_3: "",
    // ---------------------------------------------------
    faq3: "Will They Look And Feel Natural?",
  ...
  return (
    <div className={styles.page_container}>
      ...
      <PageHeader title="Chin Filler" src="/chinFiller.png" />

      <PageMain questions={faq} title="Chin Filler" />
      <Footer />
    </div>
  );
}
