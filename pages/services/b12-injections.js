...
export default function B12Injections() {
  const faq = {
    ...
    // ------------------------------------------------
    faq1: "What Are The Benefits Of B12 Injections?",

    an1: "There are numerous benefits to having B12 injections. Your energy levels will increase, which many individuals find helpful in allowing them to exercise effectively. This change will benefit every aspect of your day-to-day life.",
    ...
    // ----------------------------------------------
    faq2: "How Do You Feel After A B12 Injection?",

    an2: "There are minor downsides to getting B12 injections. The injection is delivered directly into the muscle, which means you may experience some pain, swelling or itching at the injection site.",
    ...
    an2_3: "",
    // ---------------------------------------------------
    faq3: "How Soon Do B12 Injections Start Working?",

    an3: "As with most treatments, the speed at which results are felt differ from person to person. It may take up to a few weeks to feel the alleviation of extreme tiredness and lack of energy. However, remember that the first 48-72 hours will see your red blood cell count increasing rapidly.",
    ...
    // -------------------------------------------------
    faq4: "Safety And Side Effects",

    an4: "B12 injections are well-known for being very safe. Whilst there may be some mild pain, swelling or itching, these side effects are all short term. There are no major side effects.",
  ...
  return (
    <div className={styles.page_container}>
      ...
      <PageHeader title="B12 Injections" src="/b12.png" />

      <PageMain questions={faq} title="B12 Injections" />
      <Footer />
    </div>
  );
}
